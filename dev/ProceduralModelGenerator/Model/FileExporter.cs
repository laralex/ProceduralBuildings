...
namespace ProceduralBuildingsGeneration
{
    public class FileExporter : IExporter
    {
        ...
        private bool Export(List<WriteMesh> data, ExportParameters parameters)
        {
            ...
            var filepath = Path.Combine(fileParameters.Directory, fileParameters.FileName + fileParameters.FileExtention);
            //File.Delete(filepath);
            var ioResult = new StandardMeshWriter().Write(filepath, data, writeOptions);
