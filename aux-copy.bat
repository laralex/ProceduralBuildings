...
echo = ProceduralModelGenerator = View
xcopy /Y /C /H /Q dev\ProceduralModelGenerator\View\bin\Release\netcoreapp2.1\*.dll ship\bin\*.dll > nil
xcopy /Y /C /H /Q dev\ProceduralModelGenerator\View\bin\Release\netcoreapp2.1\*.exe ship\bin\*.exe > nil
